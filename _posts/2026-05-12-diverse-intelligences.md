---
layout: post
title: Diverse intelligences, alien intelligences
categories: [thoughts, presentation]
tags: [diversity, intelligence, ai]
---

Last Wednesday (2026-05-06) I gave a short presentation at [DIVSOL](https://www.helsinki.fi/en/diversity-society-and-life), the *Diversity in Society and Life* research community at the University of Helsinki. In the talk I explain how the research I've done over the past decade or so relates to the general theme of diversity in science and society.
...
![Difference by Scott E Page](/assets/difference.jpg)

In that video, Page was presenting his (and his coauthor's) famous finding from 2004, the [diversity trumps ability theorem](https://www.pnas.org/doi/10.1073/pnas.0403723101). The upshot of the theorem is that when people solve problems together, in groups, it makes sense to maximize the diversity of the group members instead of building the group from the individually best performers. This finding has later had lots of implications e.g. for hiring, when companies started following it in recruiting ([McKinsey 2015](https://www.mckinsey.com/insights/organization/~/media/2497d4ae4b534ee89d929cc6e3aea485.ashx)). (But for some of the rather depressing recent developments, see [here](https://www.samulireijula.net/assets/reijula_diversiteetti_2025-03-24.pdf))
...
Using modeling techniques from biology and economics, Kitcher's paper launched a new field, which could be called **social epistemology of science**, and that's the field that I've been working in since that afternoon in 2013 ([O'Connor 2023](https://www.cambridge.org/core/elements/abs/modelling-scientific-communities/1ED3515216067E40A37A72094EE3CB15), [Šešelja 2023](https://plato.stanford.edu/entries/agent-modeling-philscience/)).
...
My main interest has been in [cognitive diversity](https://link.springer.com/article/10.1007/s11229-016-1147-4): We say that a group is cognitively diverse when its members differ, for example, with respect to their disciplinary background, expertise and skills, problem-solving heuristics, or strategy that each group member uses to explore a common field of research. 

Cognitive diversity can be distinguished from **demographic diversity** (its members occupying different social locations, e.g., with respect to gender, class, ethnic identity, nationality, and race), and from **social value diversity** (when its members endorse different social and political values, or act as representatives of different interest groups). More on these concepts in [Rolin et al. 2023](https://link.springer.com/article/10.1007/s11229-023-04261-9).
...
(In political philosophy, a similar case has recently been made for democratic decision making, most forcefully by [Helene Landemore](https://www.tandfonline.com/doi/abs/10.1080/08913811.2014.940780).)

Cognitive diversity was of the key concepts of my 2020-2025 Academy fellow project called [Modeling the republic of science](https://www.samulireijula.net/projects/). Obviously there is no one way that diversity works in science. You could say it has several functions, and these functions are served by different mechanisms. 
...
The table is far from exhaustive, and does not include the potential downsides or costs of diversity to research. Here I just want to point out one thing (Row 5): Philosophers don't agree about most things, but in philosophy of science there's almost a universal consensus that scientific knowledge cannot be found in the brain of any particular scientist. Instead, scientific knowledge is collectively held by the scientific community. Furthermore as feminist philosopher of science Helen Longino [(1990)](https://press.princeton.edu/books/paperback/9780691020518/science-as-social-knowledge?srsltid=AfmBOoppiBA1DcQAWLqMHsYmgwG7U54RixopPE239eAlBBZT7GwGMNdL) famously argued, the objectivity of that knowledge is guaranteed by critical exchange of arguments among a diverse community of scientists. 

### Cognitively diverse university

In 2023 my colleague [Säde Hormio](https://blogs.helsinki.fi/sade-hormio/) and I took some of these ideas and applied them to higher-education research. Based on diversity arguments, we put forward a new argument for academic freedom: Namely, that the capacity of universities to serve the society by discovering significant truths depends on us having sufficiently diverse repertoires of (1) problems we study , (2) solutions we develop, and (3) people thinking about the world in different ways.

[![1st page of Universities as Anarchic Knowledge Institutions](/assets/hormio-reijula-2023-1st-page.jpg)](https://www.tandfonline.com/doi/full/10.1080/02691728.2023.2283444)

### Alien intelligences and existential implications

Here's what I'm doing now (2026-05). I have a new research project starting on June 1st, 2026: [Scientist in the loop - Automation of scientific discovery (SCI-AI)](https://www.samulireijula.net/projects/) is funded by an ERC Consolidator grant. The main aim of the project is to better understand how AI is changing scientific discovery.
...
I recently read this [Terence Tao interview](https://www.nature.com/articles/d41586-026-01246-9), and I agree with him that AI will change research in almost all scientific fields. But I feel strong nostalgia for pre-AI times. Many of the research skills that I spent decades learning are quickly losing value. If I could turn back the clock, I'd be perfectly happy doing my research in those pre-AI times. I'm one of those, 
mentioned by Tao, going through the five stages of grief.

![narcissus](https://upload.wikimedia.org/wikipedia/commons/3/37/Narcissus_by_Caravaggio%2C_1597%E2%80%931599%2C_Galleria_Nazionale_d%27Arte_Antica_%2821836123485%29.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=original)

SCI-AI hasn't really started yet, but one thing I want to mention is this idea that AI can be a useful reminder to us humans of our own limitations. In this [paper](https://osf.io/preprints/osf/er8dg) that I wrote together with Renne Pesonen from Tampere University, we argue that based on scientific findings (and conceptualizations) alone, there are no in-principle reasons why machines could not be **intelligent, creative, or genuinely understand language**. 
...
* tähän voisi lisätä Tomasello-esimerkin:
	* irrationaalisista jäsenistä koostuvassa rationaalisessa systeemissä ei mitään outoa jos ymmärretään että ihmisillä kyky joint actioniin, toimia osana kokonaisuutta. agency on yksilötason yläpuolella
		* ks. bear tästä
* kitcher 2011 on mavericks: foolish pursuits
-->
